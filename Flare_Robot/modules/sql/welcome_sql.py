...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "{first} ara ara you ready ? my Playboy",
    "Dear hentai protaganist ,.{first} is here",
    "A wild Rapist kun {first} appeared",
    "{first} came in like a uglybastard (+_+) start!",
    "{first} has joined your OYO Room",
    "{first} just joined. Can I get a rubber ?",
    "{first} just joined the chat - yamate yamate kudasaiiiiii  aaaa💦!!!!",
    "{first} just joined. Everyone, look busy watching hentai !",
    "Welcome, {first}. Stay awhile and listen my aaaaaa💦!",
    "Welcome, {first}. We were expecting you ( ‌° ‌ʖ ‌°)",
    "Welcome, {first}. We hope you brought some  rubbers (◍•ᴗ•◍)❤",
    "Welcome, {first}. Leave your Clothes by the door ^_^"
    "Swoooosh. {first} just Cumms",
    "Nude yourselves. {first} just joined the chat",
    "{first} just joined. Hide your bananas",
    "{first} just arrived. Seems sexy :-P",
    "{first} just arrived. Seems happy :-)",
    "{first} just arrived. Seems lewd ",
    "{first} just arrived. Seems Erotic ^_^",
    "{first} just arrived. Seems Virgin (sad vanilla protaganist )",
    "{first} just arrived. Seems Play-boy cheated me bakaa",
    "{first} just arrived. Seems NTR FAN",
    "{first} just arrived.  Kawaiii >.<",
    "{first} just Cumms into the chat",
    "A {first} has been fucked up in the chat",
    "Big {first} showed up his Dick!",
    "Where’s {first}? In the OyO!",
    "{first} ready to get a sex !!",
    "{first} just showed up. Hold my oppai",
    "Hentai  approaching for lewds! {first} let me grab my ban Excalibur",
]
DEFAULT_GOODBYE_MESSAGES = [
    "{first} Are you sure you are down for your homies ? .",
    "{first}  he will never get a girlfriend .",
    "{first}  leave kardia, kabhi maths me pass nahi ho sakta tu .",
    "{first} has left the Rias alone .",
    "{first} has left the Zero-two alone .",
    "{first} has Got a new spank  partner I guess!.",
    "{first} is out of Cumms!.",
    "Pehli fursat me nikal.  {first}!",
    "It was a fun ignoring you  🗿👍{first}.",
    "We hope to see your small  d!ck again soon, {first}.",
    "I donut want to say goodbye, {first}.",
    "Goodbye {first}! Guess who's gonna miss your oppai :')",
    "Goodbye {first}! Get out from our gang .",
    "Please don't leave me alone when I'm this wet, {first}!",
    "Good luck for your exams I guess, {first}!",
    "You know we're not  gonna miss your dumb thing  {first}. Right? Right? Right?",
    "Congratulations, {first}! You're officially free of this best  chat.",
    "{first}. Blame that owner .",
    "You're leaving, {first}? Yare Yare Daze.",
    "Never gonna get a girlfriend",
    "Go outside di!kless unkil!",
    "Ask again for sex later",
    "Think for your babes",
    "Question to simp authority",
    "You are worshiping a porn god so get the hell out ",
    "He watches porn get the hell out of here degenerate",
    "Sorry nobody want to simp on you !",
    "Marry and reproduce",
    "Stay asleep with me ",
    "Can't Hard up his  d!ck",
]
