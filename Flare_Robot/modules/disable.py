...
from Flare_Robot.modules.helper_funcs.handlers import CMD_STARTERS, SpamChecker
from Flare_Robot.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from Flare_Robot.modules.sql import disable_sql as sql
