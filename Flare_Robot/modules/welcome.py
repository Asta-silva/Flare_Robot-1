...
from Flare_Robot.modules.helper_funcs.msg_types import get_welcome_type
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "My Sexy Darling is in the house Let's party 🎉",
                    reply_to_message_id=reply,
                )
                welcome_log = (
            ...
            if new_mem.id in DEV_USERS:
                update.effective_message.reply_text(
                    "My Flirt Partner Dev is Here, let's see what happened now 🔥",
                    reply_to_message_id=reply,
                )
                continue
            ...
            if new_mem.id in DRAGONS:
                update.effective_message.reply_text(
                    "My Cute Dragon is Here, let's see what happened now 🔥",
                    reply_to_message_id=reply,
                )
                continue
