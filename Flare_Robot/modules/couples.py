...
from Flare_Robot.modules.mongo.couples_mongo import get_couple, save_couple
...
async def couple(_, message):
    ...
    try:
        ...
        if not is_selected:
            ...
            couple_selection_message = f"""**OyO Couple Of The Day Who Got The Free OYO Tickets:**
