...
import html
import requests
import Flare_Robot.modules.sql.chatbot_sql as sql
...
from Flare_Robot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from Flare_Robot import dispatcher, updater, SUPPORT_CHAT
...
CHATBOTK_HANDLER = CommandHandler("chatbot", "mittumiya", "chalbol", kuki, run_async=True)
