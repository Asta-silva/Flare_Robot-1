...
from Flare_Robot.modules.mongo.karma_mongo import is_karma_on, karma_off, karma_on

karma_positive_group = 3
karma_negative_group = 4

regex_upvote = r"^((?i)\+|\+\+|\+1|thx|tnx|ty|thank you|thanx|thanks|themks|piro|noice|noimce|op|opp|omp|pero|pruh|tq|sahi hai|wah|wahh|wahhh|kya bat|goomd|pro|cool|good|👍)$"
regex_downvote = r"^(\-|\-\-|\-1|buri bat|bitch|bish|f|fuck|wtf|tf|bsdk|lode|👎)$"
